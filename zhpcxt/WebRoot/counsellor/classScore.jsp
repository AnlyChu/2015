			...
			<table width="100%">
				<thead>
					...
					<tr class="thead">
						...
						<td align="center"><select name="schoolYear" onchange="getSchoolYear(this.value);">
								<option >学年</option>
								<%
						...
						<td align="center"><select name="term" onchange="getTerm(this.value);">
								...
								%>
								<option value=<%=getTerm.get(0)%>><%=getTerm.get(0)%></option>
								<%
									}}
								%>
						</select></td>
				...
				<tbody class="tbody">
					...
					%>
					<tr>
						<td align="center"><%=getScoreOfSchYear2.get(0)%></td>
						<td align="center"><%=getScoreOfSchYear2.get(1)%></td>
						<td align="center"><%=getScoreOfSchYear2.get(2)%></td>
						<td align="center"><%=getScoreOfSchYear2.get(3)%></td>
						<td align="center"><%=course1.get(1)%></td>
						<td align="center"><%=getScoreOfSchYear2.get(5)%></td>
					</tr>
					<%
					...
					%>
					<tr>
						<td align="center"><%=getScoreOfTerm2.get(0)%></td>
						<td align="center"><%=getScoreOfTerm2.get(1)%></td>
						<td align="center"><%=getScoreOfTerm2.get(2)%></td>
						<td align="center"><%=getScoreOfTerm2.get(3)%></td>
						<td align="center"><%=course1.get(1)%></td>
						<td align="center"><%=getScoreOfTerm2.get(5)%></td>
					</tr>
					<%
						}
						}
